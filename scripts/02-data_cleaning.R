...
master_clean8 <- subset(master_clean7, health != ".s:  Skipped on Web")
rm(master_clean7)

master_clean9 <- subset(master_clean8, hapmar != ".n:  No answer")
rm(master_clean8)

master_clean10 <- subset(master_clean9, hapmar != ".s:  Skipped on Web")
rm(master_clean9)
